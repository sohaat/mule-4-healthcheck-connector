...
@Operations({
        ...
        TestExpressionOperations.class})

public class HealtcheckConnectorConfig {

    private static final Logger LOGGER = LoggerFactory.getLogger(HealtcheckConnectorConfig.class);
