...
public class DatabaseOperations {	
	...
	@Summary("Indicate which DB config should be associated with this healtcheck.")
	@Placement(order = 2)
	...
	public Healtcheck getDbHealthCheck(
		...
		Healtcheck response = new Healtcheck(serviceName, type, status,(Integer) Math.toIntExact(elapsedTime),errorString);
