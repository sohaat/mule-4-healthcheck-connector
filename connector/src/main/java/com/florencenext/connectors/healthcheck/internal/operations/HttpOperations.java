...
public class HttpOperations {
	...
	@Summary("Indicate which HTTP config should be associated with this healtcheck.")
	@Placement(order = 2)
	...
	public Healtcheck getHttpHealthCheck(@Placement(order = 5) @Optional @NullSafe @Content(primary = true) Map<String, String> httpHeaders,
